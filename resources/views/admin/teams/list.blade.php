<x-admin-layout>
    ...
    <x-slot name="header">
        @include('admin.teams.navigation')
    </x-slot>
                                        ...
                                        <div class="flex -space-x-4 rtl:space-x-reverse">
                                            @foreach($team->members as $member)
                                                {{-- <a href={{route('admin.members.show', $member->id)}}> --}}
                                                    <img class="w-10 h-10 border-2 border-white rounded-full dark:border-gray-800" src={{$member->profile_picture_url}} alt={{$member->name}} />
                                                {{-- </a> --}}
                                            @endforeach
                                        </div>
                                    </div>
